...
## 🐶 Спробувати готового бота
Не хочеш запарюватись із серверами та кодом? Залітай до вже готового Мопса, він працює 24/7 і готовий до прожарки:
👉 **[@schurmanbot](https://t.me/schurmanbot)** 👈

Просто переходь за посиланням, натискай `/start` і пиши йому!

---

## 🚀 Що нового у Версії 2.0
* 👁 **Vision (Аналіз фото):** Відправ Мопсу фотографію, і він жорстко її просмажить або прокоментує те, що бачить!
* 🛡 **Anti-Spam (Rate Limiting):** Вбудований захист від флуду. Якщо боту пишуть занадто швидко, він ставитиме запити в чергу або сваритиметься.
* 🧠 **Динамічні настрої та Розумна пам'ять:** Бот періодично змінює настрій (злий, під чифіром, філософ) і запам'ятовує до 15 повідомлень з розмови.
* 📢 **Адмінська розсилка:** Команда `/broadcast` для масової розсилки повідомлень всім користувачам бази.
